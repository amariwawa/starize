...
const Hero = () => {
  return (
    <section className="relative min-h-[60vh] md:min-h-screen w-full max-w-full flex items-end justify-center overflow-hidden bg-black pb-24 md:pb-32">
      ...
      />
      {/* Background Image (Mobile - Balanced Height) */}
      <div
