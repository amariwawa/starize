    ...
    <section className="relative min-h-[85vh] md:min-h-screen w-full max-w-full flex items-end justify-center overflow-hidden bg-[#4e0505] pb-12 md:pb-60">
      ...
      <div className="absolute inset-0 z-0 md:hidden overflow-hidden">
        ...
        >
          ...
          <p className="text-on-surface/60 text-[10px] font-bold uppercase tracking-widest leading-none">Saturday, 6th June 2026 • 2 PM</p>
        </motion.div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center w-full">
        ...
        >
          ...
          <p className="text-on-surface/80 text-base font-bold uppercase tracking-widest">Saturday, 6th June 2026 • 2 PM</p>
        </motion.div>
