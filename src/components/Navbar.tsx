...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 glass-nav border-b border-white/5 shadow-lg overflow-hidden max-w-full">
      <div className="max-w-7xl mx-auto px-1 md:px-10 flex items-center justify-between py-2 md:py-8 h-20 md:h-32 transition-all duration-300 overflow-hidden">
        {/* Left: Even BIGGER Logo - Optimized for left-shift */}
        <div className="flex-none flex items-center h-full">
          <Link href="/" className="transition-all duration-300 hover:scale-105 active:scale-95 flex items-center">
            <img 
              src="/logo.png" 
              alt="STARIZE Logo" 
        ...
        <div className="flex-grow flex items-center justify-start ml-1 overflow-hidden">
        ...
        <div className="flex-none flex items-center">
          <button
            ...
            className="liquid-gold-btn text-on-primary px-3 md:px-8 py-2 md:py-3 rounded-full text-[10px] md:text-sm font-headline font-black active:scale-95 duration-150 transition-all shadow-xl whitespace-nowrap"
          >
            Vote Now
          </button>
        </div>
