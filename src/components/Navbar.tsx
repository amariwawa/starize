...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 glass-nav border-b border-white/5 shadow-lg overflow-hidden max-w-full">
      <div className="max-w-7xl mx-auto px-6 md:px-10 flex items-center h-20 md:h-32 transition-all duration-300 relative">
        ...
        <div className="flex-1 md:absolute md:left-1/2 md:-translate-x-1/2 z-0 flex justify-end md:justify-center whitespace-nowrap">
